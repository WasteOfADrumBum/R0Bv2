  ...
  return (
    <div className="greenSock my-5">
      ...
      <div className="greenSockIntro my-2">
        ...
        superheros. GSAP obesess about performance, compatibility, and support
        so that the developer doesn't have to. Desgined to be compatible with
        HTML, SVG, React.js, jQuery, CSS, modern borwsers and mobile devices
        it's my frist choice for complex animations.
      </div>
